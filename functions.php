...
function moose_frame_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Sidebar 4', 'moose-frame' ),
		'id'            => 'footer-sidebar-4',
		'description'   => '',
		'before_widget' => '<section id="%1$s" class="widget-footer %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Sidebar 5', 'moose-frame' ),
		'id'            => 'footer-sidebar-5',
		'description'   => '',
		'before_widget' => '<section id="%1$s" class="widget-footer %2$s">',
		'after_widget'  => '</section>',
		...
		register_sidebar( array(
		'name'          => esc_html__( 'Frontpg ConverKit Form Widget', 'moose-frame' ),
		'id'            => 'frontpg-convertkit',
		'description'   => '',
		'before_widget' => '<section id="%1$s" class="widget-footer %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
...
function moose_frame_scripts() {
	wp_enqueue_style( 'moose-frame-style', get_stylesheet_uri(), '', '5.0' );
...
/**
 *
 * Making Text Widget Do Shortcode
 *
 */
