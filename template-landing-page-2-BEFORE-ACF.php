 ...
 * Template Name: Landing Page without Gray Bottom Block BEFORE ACF
  ...
  <div class="container">
    ...
    <article class="body row">
      ...
      <div class="col-sm-6 col-md-6 col-lg-6">
        ...
        <ul class="the-list">
          <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque interdum tortor sodales dui congue faucibus.</li>
          <li>
      ...
      <div class="col-sm-6 col-md-6 col-lg-6">
        ...
        <div class="btn-holder">
          ...
          <!-- <a class="btn btn-default btn-block" href="/thank-you/" title="">YES! TAKE ME TO FREE DOWNLOADS</a> -->
